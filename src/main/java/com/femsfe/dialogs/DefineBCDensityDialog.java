...
public class DefineBCDensityDialog extends TextInputDialog {
    ...
    public DefineBCDensityDialog(ProblemType type) {
        ...
        switch (Project.getProblemType()) {
            case ELETROSTATIC:
                this.setGraphic(new ImageView(new Image(App.class.getResourceAsStream("icon/BC_surface_charge_density.png"))));
            ...
            case MAGNETOSTATIC_VECTOR_POTENTIAL:
                this.setGraphic(new ImageView(new Image(App.class.getResourceAsStream("icon/BC_surface_current_density.png"))));
