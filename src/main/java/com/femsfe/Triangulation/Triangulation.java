...
/**
 * A abstract class of a Triangulation used for domain discretization of a model
 * 2d .
 *
...
public abstract class Triangulation {
     ...
     * @param w thrid point
     * @return Value > 0 , then is clockwise. Value < 0, then is anticlockwise.
     * Value = 0 , then is Collinear. @since 1.0 
	  *
     */
    ...
    /**
     * Verify if the edge sastified the delaunay condition, if not, then the
     * sweep are made
     *
     *
     */
    ...
    /**
     * Return if the 4 points obey the delaunay criterium, to the maximize the
     * minimium angle.
     *
     * @param p0 point 1
     * @param p1 point 2
     * @param p2 point 3
     * @param p test point
     * @return true if the point p is inside the circum-circle formed by the
     * points p0,p1,p2. Otherwise, is false.
     * @since 1.0
	 *
     */
