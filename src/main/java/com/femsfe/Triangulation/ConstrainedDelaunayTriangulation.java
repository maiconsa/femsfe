...
import com.femsfe.Geometries.OrderByAngle;
import com.femsfe.Geometries.Point2D;
import com.femsfe.Geometries.Triangle2D;
import com.femsfe.Project;

/**
 * A subclass of <code>Triangulation</code> used for domain discretization of a
 * model 2d .
 *
...
public class ConstrainedDelaunayTriangulation extends Triangulation {
    ...
    /**
     * Return the element that has the point v as vertex and it intersects by
     * the cutEdge. This methos is used in addEdgeCDT method. The searching
     * occur in conectivity list that belong to model.
     *
     * @param v a
    ...
    /**
     * Return the opposed element based on a triangle t and a point v. This
     * method is required for the intersection searching used in addEdgeCDT
     * method.
     *
     * @param t element
     * @param v vertex
    ...
    private void addEdgeCDT(Line2D edge) {
        ...
        Set<Point2D> PU = new HashSet<>();
        Set<Point2D> PL = new HashSet<>();
        Triangle2D tOpo;
